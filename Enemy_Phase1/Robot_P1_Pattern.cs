...
public class Robot_P1_Pattern : MonoBehaviour
{
    ...
    void SetState(Robot_P1 boss, string command)
    {
        ...
        {
            case "Clap":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P1_ATTACK_CLAP);
                break;
            case "Takedown":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P1_ATTACK_TAKEDOWN);
                break;
            case "Dead":
                robotP1.ChangeState(Robot_P1.RobotP1_State.DEAD);
                break;
            case "Punch":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P2_ATTACK_PUNCH);
                break;
            case "Smash":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P2_ATTACK_SMASH);
                break;
            case "missile":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P3_ATTACK_HOMING_MISSILE);
                break;
            case "earth":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P3_ATTACK_EARTHQUAKE);
                break;
            case "claw":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P3_ATTACK_CLAW_ATTACK);
                break;
            case "bomb":
                robotP1.ChangeState(Robot_P1.RobotP1_State.P3_ATTACK_BOMB);
                break;
