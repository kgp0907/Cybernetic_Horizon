...
public class RobotP3_State_ClawAtk : Interface_Base<Robot_Base>
{
    ...
    IEnumerator ClawAtk(Robot_Base robot_p1)
    {
        ...
        yield return StaticCoroutine.WaitUntil(robot_p1.animation_id, robot_p1.m_Animator, 0.55f);
        robot_p1.RobotP3.colision_P3_RightArm.SetActive(true);

        yield return StaticCoroutine.WaitUntil(robot_p1.animation_id, robot_p1.m_Animator, 0.63f);
        robot_p1.RobotP3.colision_P3_RightArm.SetActive(false);
        robot_p1.RobotP3.colision_P3_LeftArm.SetActive(true);

        yield return StaticCoroutine.WaitUntil(robot_p1.animation_id, robot_p1.m_Animator, 0.68f);
